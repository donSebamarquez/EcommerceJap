    ...
    sellForm.addEventListener("submit", function (e) {
        ...
        if (!infoMissing) {
            ...
            const payload = {
                ...
                currency: MONEY_SYMBOL.trim(),
                commission: comissionPercentage,
                count: productCount
            };
            ...
            fetch(PUBLISH_PRODUCT_URL, {
                ...
                .then(data => {
                    ...
                    msgToShowHTML.innerHTML = data.message || "Producto publicado correctamente";
                    document.getElementById("alertResult").classList.add("show", "alert-primary");
                })
                .catch(err => {
                    const msgToShowHTML = document.getElementById("resultSpan");

                    msgToShowHTML.innerHTML = "Error al publicar el producto.";
                    document.getElementById("alertResult").classList.add("show", "alert-danger");
                });
        }
    });
});